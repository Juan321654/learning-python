...
# convert this function is_leap() so that instead of printing "Leap year."
# or "Not leap year." it should return True if it is a leap year
...
# And it will use this information to work out the
# number of days in the month, then return that as the output, e.g.: 28
